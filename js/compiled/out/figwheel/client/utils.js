...
var or__43806__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj52640 = {"detail":data};
return obj52640;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__43794__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__43794__auto__)){
var and__43794__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__52647 = cljs.core._EQ_;
var expr__52648 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__52647.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__52648))){
return ((function (pred__52647,expr__52648){
return (function (p1__52641_SHARP_){
return console.warn(p1__52641_SHARP_);
});
;})(pred__52647,expr__52648))
} else {
if(cljs.core.truth_(pred__52647.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__52648))){
return ((function (pred__52647,expr__52648){
return (function (p1__52642_SHARP_){
return console.debug(p1__52642_SHARP_);
});
;})(pred__52647,expr__52648))
} else {
if(cljs.core.truth_(pred__52647.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__52648))){
return ((function (pred__52647,expr__52648){
return (function (p1__52643_SHARP_){
return console.error(p1__52643_SHARP_);
});
;})(pred__52647,expr__52648))
} else {
return ((function (pred__52647,expr__52648){
return (function (p1__52644_SHARP_){
return console.log(p1__52644_SHARP_);
});
;})(pred__52647,expr__52648))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__52651){
var map__52652 = p__52651;
var map__52652__$1 = ((((!((map__52652 == null)))?((((map__52652.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52652.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52652):map__52652);
var opts = map__52652__$1;
var eval_fn = cljs.core.get.call(null,map__52652__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__52654_SHARP_);
});})(new_def))
);
...
return (function (p__52655){
var vec__52656 = p__52655;
var ky = cljs.core.nth.call(null,vec__52656,(0),null);
var v = cljs.core.nth.call(null,vec__52656,(1),null);
...
if(cljs.core.truth_((function (){var and__43794__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1505037973923
