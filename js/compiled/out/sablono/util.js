...
var x__44539__auto__ = (((x == null))?null:x);
var m__44540__auto__ = (sablono.util.to_str[goog.typeOf(x__44539__auto__)]);
if(!((m__44540__auto__ == null))){
return m__44540__auto__.call(null,x);
} else {
var m__44540__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__44540__auto____$1 == null))){
return m__44540__auto____$1.call(null,x);
} else {
...
var x__44539__auto__ = (((x == null))?null:x);
var m__44540__auto__ = (sablono.util.to_uri[goog.typeOf(x__44539__auto__)]);
if(!((m__44540__auto__ == null))){
return m__44540__auto__.call(null,x);
} else {
var m__44540__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__44540__auto____$1 == null))){
return m__44540__auto____$1.call(null,x);
} else {
...
var len__45083__auto___46201 = arguments.length;
var i__45084__auto___46202 = (0);
while(true){
if((i__45084__auto___46202 < len__45083__auto___46201)){
args__45090__auto__.push((arguments[i__45084__auto___46202]));

var G__46203 = (i__45084__auto___46202 + (1));
i__45084__auto___46202 = G__46203;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__45091__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq46200){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq46200));
});
...
var vec__46204 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__46206;
var words = seq__46205__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__46207){
...
return cljs.core.update.call(null,G__46211,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__46211;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__43806__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1505037969511
