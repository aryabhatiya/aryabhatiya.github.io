...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__46214){
var vec__46215 = p__46214;
var _ = cljs.core.nth.call(null,vec__46215,(0),null);
var v = cljs.core.nth.call(null,vec__46215,(1),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__46218_SHARP_){
return ((p1__46218_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__46218_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__46219,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__46219;
}
});
...
var len__45083__auto___46222 = arguments.length;
var i__45084__auto___46223 = (0);
while(true){
if((i__45084__auto___46223 < len__45083__auto___46222)){
args__45090__auto__.push((arguments[i__45084__auto___46223]));

var G__46224 = (i__45084__auto___46223 + (1));
i__45084__auto___46223 = G__46224;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__45091__auto__);
});
...
var G__46221 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__46221,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__46221;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq46220){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq46220));
});
...
var vec__46227 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__46227,(0),null);
var names = cljs.core.nth.call(null,vec__46227,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__46227,tag_name,names){
return (function (p1__46225_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__46225_SHARP_))){
return p1__46225_SHARP_;
} else {
return null;
}
});})(matches,vec__46227,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__46227,tag_name,names){
return (function (p1__46226_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__46226_SHARP_));
});})(matches,vec__46227,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__46230){
...
var tag = first__46233;
var content = seq__46232__$1;
...
var vec__46234 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__46234,(0),null);
var id = cljs.core.nth.call(null,vec__46234,(1),null);
var class$ = cljs.core.nth.call(null,vec__46234,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1505037969548
